...
// office with one desk used in the floor B2
export function createOffice1DeskB2(deskIds = []) {
    ...
    makeInstance('/assets/models/Cabin.glb')
        .then((cabin) => {
            cabin.position.set(0.98, 0.8, 3.05);
    ...
    makeInstance('/assets/models/Window.glb')
        .then((window) => {
            window.position.set(6, 1.3, 1.75);
            window.scale.set(2.7, 1.8, 1.8);
