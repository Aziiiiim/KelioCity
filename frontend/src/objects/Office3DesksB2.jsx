...
// office with three desks used in floor B2
export function createOffice3DesksB2(deskIds = []) {
    ...
    floorMesh.position.set(3,0.01,2.745)
    elements.add(floorMesh);

    const wallGeo1 = new THREE.PlaneGeometry(6, 4);
    const wallGeo2 = new THREE.PlaneGeometry(5.49, 4);
    ...
    wallMesh2.position.set(5.99,2,2.745);
    ...
    makeInstance('/assets/models/Cabin.glb')
        .then((cabin) => {
            cabin.position.set(1.8, 0.8, 5.05);
